...
namespace student2._3
{
    public class Student
    {
        ...
        {
            this.Average = (this.dBEL + this.dForeign + this.dMath + this.dChem + this.dPhys + this.dBio) / 6d;
        }

        public void spravka()
        {
            Console.WriteLine("С П Р А В К А");
            Console.WriteLine($"за успеха на {this.name}, ученик от");
            Console.WriteLine($"{this.schoolClass} {this.Paralelka} клас, номер {this.id}");
            Console.WriteLine($"BEL           - {this.dBEL}");
            Console.WriteLine($"Foreign       - {this.dForeign}");
            Console.WriteLine($"Math          - {this.dMath}");
            Console.WriteLine($"Phys          - {this.dPhys}");
            Console.WriteLine($"Chem          - {this.dChem}");
            Console.WriteLine($"Bio           - {this.dBio}");
            Console.WriteLine($"Average grade - {Math.Round(this.Average, 2)}");
        }
    }
